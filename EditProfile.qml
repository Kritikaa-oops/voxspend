...
Item {
    ...
    Column {
        ...
        Rectangle {
            width: parent.width; height: 50; radius: 10; border.color: "#E0E0E0"
            TextField { id: nameInput; anchors.fill: parent; anchors.margins: 8; text: "diya"; background: null }
        }

        Text { text: "Email"; color: "#777"; font.pixelSize: 13 }
        Rectangle {
            width: parent.width; height: 50; radius: 10; border.color: "#E0E0E0"
            TextField { id: emailInput; anchors.fill: parent; anchors.margins: 8; text: "diya@example.com"; background: null }
        }

        Text { text: editProfilePage.errorMessage; color: "red"; font.pixelSize: 12; visible: text !== "" }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    console.log("Saved Changes:", nameInput.text, emailInput.text)
                    stackView.pop()
                }
            }
        }
