        ...
        Column { width: Math.min(expenseScroll.availableWidth - 48, 540); anchors.horizontalCenter: parent.horizontalCenter; topPadding: 28; bottomPadding: 30; spacing: 14
            ...
            Rectangle { width: parent.width; height: 360; radius: 18; color: "white"; border.color: "#E4E7EF"
                Column { anchors.fill: parent; anchors.margins: 20; spacing: 9
                    ...
                    TextField { id: titleField; width: parent.width; height: 40; placeholderText: "e.g. Groceries"; background: Rectangle { radius: 9; color: "#F7F8FC"; border.color: titleField.activeFocus ? "#1E3A8A" : "#E2E6EF"; border.width: titleField.activeFocus ? 2 : 1 } }
                    ...
                    Row { width: parent.width; height: 40; spacing: 8
                        Rectangle { width: 56; height: parent.height; radius: 9; color: "#E8F0FF"; Text { text: "Rs"; color: "#1E3A8A"; font.bold: true; anchors.centerIn: parent } }
                        TextField { id: amountField; width: parent.width - 64; height: parent.height; placeholderText: "0.00"; inputMethodHints: Qt.ImhFormattedNumbersOnly; validator: DoubleValidator { bottom: 0 } background: Rectangle { radius: 9; color: "#F7F8FC"; border.color: amountField.activeFocus ? "#1E3A8A" : "#E2E6EF"; border.width: amountField.activeFocus ? 2 : 1 } }
                    }
                    Text { text: "CATEGORY"; color: "#667087"; font.pixelSize: 10; font.bold: true; font.letterSpacing: 1 }
                    ComboBox { id: categoryBox; width: parent.width; height: 40; model: ["Select category", "Food", "Travel", "Shopping", "Other"]; background: Rectangle { radius: 9; color: "#F7F8FC"; border.color: "#E2E6EF" } }
            ...
            Rectangle { width: parent.width; height: 48; radius: 12; color: "#1E3A8A"
                Text { text: "Set expense"; color: "white"; font.pixelSize: 15; font.bold: true; anchors.centerIn: parent }
